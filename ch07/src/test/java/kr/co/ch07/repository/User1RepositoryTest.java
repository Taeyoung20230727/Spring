...
import kr.co.ch07.repository.board.service.repository.User1Repository;
...
class User1RepositoryTest {
    ...
    public void findUser1ByUid(){
        User1 user1 = repository.findUser1ByUid("a023");
    ...
    public void findUser1ByUidAndName(){
        User1 user1s = repository.findUser1ByUidAndName("a023", "홍길복");
        log.warn(user1s.toString());
    }
    @Test
    ...
    public void findUser1ByAgeBetween(){
        List<User1> user1s = repository.findUser1ByAgeBetween(23, 30);
        log.warn(user1s.toString());
    }

    @Test
    public void findUser1ByNameLike(){
        List<User1> user1s = repository.findUser1ByNameLike("김");
        log.warn(user1s.toString());
    }
    @Test
    public void findUser1ByNameContains(){
        List<User1> user1s = repository.findUser1ByNameContains("이");
        log.warn(user1s.toString());
    }
    @Test
    ...
    public void findUser1ByAgeGreaterThanOrderByAgeDesc(){
        List<User1> user1s = repository.findUser1ByAgeGreaterThanOrderByAgeDesc(28);
        log.warn(user1s.toString());
    }

    @Test
    public void countUser1ByUid(){
        int user1s = repository.countUser1ByUid("A102");
        log.warn(String.valueOf(user1s));
    }
    @Test
    public void countUser1ByName(){
        int user1s = repository.countUser1ByName("이순신");
        log.warn(String.valueOf(user1s));
    }
    ...
    public void selectUser1ByName(){
        List<User1> user1s = repository.selectUser1ByName("자일");
        log.warn(user1s.toString());
    }

    @Test
    public void selectUser1ByNameParam(){
        List<User1> user1s = repository.selectUser1ByNameParam("이순신");
        log.warn(user1s.toString());
    }

    @Test
    public void selectUser1ByUid(){
        List<Object[]> user1s = repository.selectUser1ByUid("장보고");
        log.warn(user1s.toString());
    }
