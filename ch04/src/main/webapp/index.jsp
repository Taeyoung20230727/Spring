...
<!--
    ...
    Spring MVC 라이브러리
        ...
        WebApplicationInitializer
         - 스프링 애플리케이션 초기화를 위한 인터페이스
         - DispatcherServlet을 생성하고 컨텍스트 등록
         - 웹 애플리케이션 컨텍스트(컨테이너)를 설정하고 필요한 서블릿, 필터, 리스너 등

        WebMvcConfigurer
         - 스프링 웹 MVC 구성 컴포넌트 설정을 위한 인터페이스
         - 뷰 리졸버(ViewResolver) 설정 및 ResourceHandler 설정 등 애플리케이션 전반에 걸친 자원 설정
...
------------------------------------------------------------------------------------------------------------------------
        ...
        Tomcat 관련 설정
          - 반드시 톰캣은 apache-tomcat - 10.1.19으로 해야 호환가능
